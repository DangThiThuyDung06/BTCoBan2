...
public class add_Form extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        suaMenu = new javax.swing.JMenuItem();
        xoaMenu = new javax.swing.JMenuItem();
        TKMenu = new javax.swing.JMenuItem();
        reMenu = new javax.swing.JMenuItem();
        jMenu2 = new javax.swing.JMenu();
        DXMenu = new javax.swing.JMenuItem();
        ...
        themMenu.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_A, java.awt.event.InputEvent.CTRL_DOWN_MASK));
        themMenu.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/add.png"))); // NOI18N
        themMenu.setText("Thêm");
        themMenu.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                themMenuActionPerformed(evt);
            }
        });
        jMenu1.add(themMenu);

        suaMenu.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_H, java.awt.event.InputEvent.CTRL_DOWN_MASK));
        suaMenu.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/design.png"))); // NOI18N
        suaMenu.setText("Sửa");
        suaMenu.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                suaMenuActionPerformed(evt);
            }
        });
        jMenu1.add(suaMenu);

        xoaMenu.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_D, java.awt.event.InputEvent.CTRL_DOWN_MASK));
        xoaMenu.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/waste.png"))); // NOI18N
        xoaMenu.setText("Xóa");
        xoaMenu.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                xoaMenuActionPerformed(evt);
            }
        });
        jMenu1.add(xoaMenu);

        TKMenu.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_F, java.awt.event.InputEvent.CTRL_DOWN_MASK));
        TKMenu.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/search.png"))); // NOI18N
        TKMenu.setText("Tìm kiếm");
        TKMenu.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                TKMenuActionPerformed(evt);
            }
        });
        jMenu1.add(TKMenu);

        reMenu.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_R, java.awt.event.InputEvent.CTRL_DOWN_MASK));
        reMenu.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/rotate.png"))); // NOI18N
        reMenu.setText("Refresh");
        reMenu.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                reMenuActionPerformed(evt);
            }
        });
        jMenu1.add(reMenu);
        ...
        DXMenu.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/login_20px.png"))); // NOI18N
        DXMenu.setText("Đăng xuất");
        DXMenu.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                DXMenuActionPerformed(evt);
            }
        });
        jMenu2.add(DXMenu);

        ThoatMenu.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_X, java.awt.event.InputEvent.CTRL_DOWN_MASK));
    ...
    private void DXMenuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DXMenuActionPerformed
        // TODO add your handling code here:
        FormDangNhap dk = new FormDangNhap();
        dk.setVisible(true);
        this.dispose();
        
    }//GEN-LAST:event_DXMenuActionPerformed
    ...
    private void xoaMenuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_xoaMenuActionPerformed
        // TODO add your handling code here:
        selectedIndex = table.getSelectedRow();
        quanLyThuVien qltv = ql.get(selectedIndex);
        JOptionPane.showConfirmDialog(this, "Bạn có chắc chắn muốn xóa không?");
        new quanLyThuVienDao().delete(qltv.getId());
        showTable();
    }//GEN-LAST:event_xoaMenuActionPerformed

    private void themMenuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_themMenuActionPerformed
        // TODO add your handling code here:
        quanLyThuVien ql = new quanLyThuVien();
        ql.setId(maTL_B.getText());
        ql.setLoaiTL(loaiTL_B.getSelectedItem().toString());
    ...
    }//GEN-LAST:event_themMenuActionPerformed

    private void suaMenuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_suaMenuActionPerformed
        // TODO add your handling code here:
        selectedIndex = table.getSelectedRow();
        quanLyThuVien qltv = ql.get(selectedIndex);
        new quanLyThuVienDao().delete(qltv.getId());
    ...
    }//GEN-LAST:event_suaMenuActionPerformed

    private void TKMenuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TKMenuActionPerformed
        // TODO add your handling code here:
        String maTaiLieu = maTL_B.getText();
        if(maTaiLieu.length()>0){
            ql = new quanLyThuVienDao().findTaiLieu(maTaiLieu);
    ...
    }//GEN-LAST:event_TKMenuActionPerformed

    private void reMenuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_reMenuActionPerformed
        // TODO add your handling code here:
        maTL_B.setText("");
        loaiTL_B.setSelectedIndex(0);
        tenNXB_B.setText("");
        ...
        ngayPH_B.setSelectedIndex(0);
        showTable();
    }//GEN-LAST:event_reMenuActionPerformed
    ...
    private javax.swing.JMenuItem DXMenu;
    private javax.swing.JMenuItem TKMenu;
    ...
    private javax.swing.JMenuItem reMenu;
    ...
    private javax.swing.JMenuItem suaMenu;
    ...
    private javax.swing.JMenuItem xoaMenu;
